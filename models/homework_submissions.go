...
func (q homeworkSubmissionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*HomeworkSubmission, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: failed to execute a one query for homework_submissions: %w", err)
	}
...
func (q homeworkSubmissionQuery) All(ctx context.Context, exec boil.ContextExecutor) (HomeworkSubmissionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, fmt.Errorf("models: failed to assign all query results to HomeworkSubmission slice: %w", err)
	}
...
func (q homeworkSubmissionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: failed to count homework_submissions rows: %w", err)
	}
...
func (q homeworkSubmissionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, fmt.Errorf("models: failed to check if homework_submissions exists: %w", err)
	}
...
func (homeworkSubmissionL) LoadHomework(ctx context.Context, e boil.ContextExecutor, singular bool, maybeHomeworkSubmission interface{}, mods queries.Applicator) error {
	...
	if err != nil {
		return fmt.Errorf("failed to eager load Homework: %w", err)
	}

	var resultSlice []*Homework
	if err = queries.Bind(results, &resultSlice); err != nil {
		return fmt.Errorf("failed to bind eager loaded slice Homework: %w", err)
	}

	if err = results.Close(); err != nil {
		return fmt.Errorf("failed to close results of eager load for homeworks: %w", err)
	}
	if err = results.Err(); err != nil {
		return fmt.Errorf("error occurred during iteration of eager loaded relations for homeworks: %w", err)
	}
...
func FindHomeworkSubmission(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*HomeworkSubmission, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: unable to select from homework_submissions: %w", err)
	}
...
func (o *HomeworkSubmission) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to insert into homework_submissions: %w", err)
	}
...
func (o *HomeworkSubmission) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update homework_submissions row: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by update for homework_submissions: %w", err)
	}
...
func (q homeworkSubmissionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all for homework_submissions: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected for homework_submissions: %w", err)
	}
...
func (o HomeworkSubmissionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all in homeworkSubmission slice: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected all in update all homeworkSubmission: %w", err)
	}
	return rowsAff, nil
}
...
func (o *HomeworkSubmission) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert homework_submissions: %w", err)
	}
...
func (o *HomeworkSubmission) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete from homework_submissions: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by delete for homework_submissions: %w", err)
	}
...
func (q homeworkSubmissionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from homework_submissions: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by deleteall for homework_submissions: %w", err)
	}
...
func (o HomeworkSubmissionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from homeworkSubmission slice: %w", err)
	}
...
func (o *HomeworkSubmissionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to reload all in HomeworkSubmissionSlice: %w", err)
	}
...
func HomeworkSubmissionExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, fmt.Errorf("models: unable to check if homework_submissions exists: %w", err)
	}
