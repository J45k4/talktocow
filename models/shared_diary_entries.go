...
func (q sharedDiaryEntryQuery) One(ctx context.Context, exec boil.ContextExecutor) (*SharedDiaryEntry, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: failed to execute a one query for shared_diary_entries: %w", err)
	}
...
func (q sharedDiaryEntryQuery) All(ctx context.Context, exec boil.ContextExecutor) (SharedDiaryEntrySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, fmt.Errorf("models: failed to assign all query results to SharedDiaryEntry slice: %w", err)
	}
...
func (q sharedDiaryEntryQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: failed to count shared_diary_entries rows: %w", err)
	}
...
func (q sharedDiaryEntryQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, fmt.Errorf("models: failed to check if shared_diary_entries exists: %w", err)
	}
...
func FindSharedDiaryEntry(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*SharedDiaryEntry, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: unable to select from shared_diary_entries: %w", err)
	}
...
func (o *SharedDiaryEntry) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to insert into shared_diary_entries: %w", err)
	}
...
func (o *SharedDiaryEntry) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update shared_diary_entries row: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by update for shared_diary_entries: %w", err)
	}
...
func (q sharedDiaryEntryQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all for shared_diary_entries: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected for shared_diary_entries: %w", err)
	}
...
func (o SharedDiaryEntrySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all in sharedDiaryEntry slice: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected all in update all sharedDiaryEntry: %w", err)
	}
	return rowsAff, nil
}
...
func (o *SharedDiaryEntry) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert shared_diary_entries: %w", err)
	}
...
func (o *SharedDiaryEntry) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete from shared_diary_entries: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by delete for shared_diary_entries: %w", err)
	}
...
func (q sharedDiaryEntryQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from shared_diary_entries: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by deleteall for shared_diary_entries: %w", err)
	}
...
func (o SharedDiaryEntrySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from sharedDiaryEntry slice: %w", err)
	}
...
func (o *SharedDiaryEntrySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to reload all in SharedDiaryEntrySlice: %w", err)
	}
...
func SharedDiaryEntryExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, fmt.Errorf("models: unable to check if shared_diary_entries exists: %w", err)
	}
