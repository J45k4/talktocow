...
var UserReceivedMessageTableColumns = struct {
	ID         string
	UserID     string
	MessageID  string
	ReceivedAt string
	...
	ID:         "user_received_message.id",
	UserID:     "user_received_message.user_id",
	MessageID:  "user_received_message.message_id",
	ReceivedAt: "user_received_message.received_at",
	ReadAt:     "user_received_message.read_at",
}
...
type (
	...
	// This should almost always be used instead of []UserReceivedMessage.
...
func (q userReceivedMessageQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UserReceivedMessage, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: failed to execute a one query for user_received_message: %w", err)
	}
...
func (q userReceivedMessageQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserReceivedMessageSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, fmt.Errorf("models: failed to assign all query results to UserReceivedMessage slice: %w", err)
	}
...
func (q userReceivedMessageQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: failed to count user_received_message rows: %w", err)
	}
...
func (q userReceivedMessageQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, fmt.Errorf("models: failed to check if user_received_message exists: %w", err)
	}
...
func FindUserReceivedMessage(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*UserReceivedMessage, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: unable to select from user_received_message: %w", err)
	}

	if err = userReceivedMessageObj.doAfterSelectHooks(ctx, exec); err != nil {
		return userReceivedMessageObj, err
	}
...
func (o *UserReceivedMessage) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to insert into user_received_message: %w", err)
	}
...
func (o *UserReceivedMessage) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update user_received_message row: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by update for user_received_message: %w", err)
	}
...
func (q userReceivedMessageQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all for user_received_message: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected for user_received_message: %w", err)
	}
...
func (o UserReceivedMessageSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all in userReceivedMessage slice: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected all in update all userReceivedMessage: %w", err)
	}
	return rowsAff, nil
}
...
func (o *UserReceivedMessage) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert user_received_message: %w", err)
	}
...
func (o *UserReceivedMessage) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete from user_received_message: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by delete for user_received_message: %w", err)
	}
...
func (q userReceivedMessageQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from user_received_message: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by deleteall for user_received_message: %w", err)
	}
...
func (o UserReceivedMessageSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from userReceivedMessage slice: %w", err)
	}
...
func (o *UserReceivedMessageSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to reload all in UserReceivedMessageSlice: %w", err)
	}
...
func UserReceivedMessageExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, fmt.Errorf("models: unable to check if user_received_message exists: %w", err)
	}
