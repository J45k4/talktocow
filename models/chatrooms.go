...
func (q chatroomQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Chatroom, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: failed to execute a one query for chatrooms: %w", err)
	}
...
func (q chatroomQuery) All(ctx context.Context, exec boil.ContextExecutor) (ChatroomSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, fmt.Errorf("models: failed to assign all query results to Chatroom slice: %w", err)
	}
...
func (q chatroomQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: failed to count chatrooms rows: %w", err)
	}
...
func (q chatroomQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, fmt.Errorf("models: failed to check if chatrooms exists: %w", err)
	}
...
func FindChatroom(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Chatroom, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: unable to select from chatrooms: %w", err)
	}
...
func (o *Chatroom) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to insert into chatrooms: %w", err)
	}
...
func (o *Chatroom) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update chatrooms row: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by update for chatrooms: %w", err)
	}
...
func (q chatroomQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all for chatrooms: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected for chatrooms: %w", err)
	}
...
func (o ChatroomSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all in chatroom slice: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected all in update all chatroom: %w", err)
	}
	return rowsAff, nil
}
...
func (o *Chatroom) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert chatrooms: %w", err)
	}
...
func (o *Chatroom) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete from chatrooms: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by delete for chatrooms: %w", err)
	}
...
func (q chatroomQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from chatrooms: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by deleteall for chatrooms: %w", err)
	}
...
func (o ChatroomSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from chatroom slice: %w", err)
	}
...
func (o *ChatroomSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to reload all in ChatroomSlice: %w", err)
	}
...
func ChatroomExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, fmt.Errorf("models: unable to check if chatrooms exists: %w", err)
	}
