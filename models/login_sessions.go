...
var LoginSessionTableColumns = struct {
	...
	Agent:     "login_sessions.agent",
	CreatedAt: "login_sessions.created_at",
}
...
func (q loginSessionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*LoginSession, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: failed to execute a one query for login_sessions: %w", err)
	}
...
func (q loginSessionQuery) All(ctx context.Context, exec boil.ContextExecutor) (LoginSessionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, fmt.Errorf("models: failed to assign all query results to LoginSession slice: %w", err)
	}
...
func (q loginSessionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: failed to count login_sessions rows: %w", err)
	}
...
func (q loginSessionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, fmt.Errorf("models: failed to check if login_sessions exists: %w", err)
	}
...
func FindLoginSession(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*LoginSession, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: unable to select from login_sessions: %w", err)
	}
...
func (o *LoginSession) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to insert into login_sessions: %w", err)
	}
...
func (o *LoginSession) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update login_sessions row: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by update for login_sessions: %w", err)
	}
...
func (q loginSessionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all for login_sessions: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected for login_sessions: %w", err)
	}
...
func (o LoginSessionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all in loginSession slice: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected all in update all loginSession: %w", err)
	}
	return rowsAff, nil
}
...
func (o *LoginSession) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert login_sessions: %w", err)
	}
...
func (o *LoginSession) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete from login_sessions: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by delete for login_sessions: %w", err)
	}
...
func (q loginSessionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from login_sessions: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by deleteall for login_sessions: %w", err)
	}
...
func (o LoginSessionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from loginSession slice: %w", err)
	}
...
func (o *LoginSessionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to reload all in LoginSessionSlice: %w", err)
	}
...
func LoginSessionExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, fmt.Errorf("models: unable to check if login_sessions exists: %w", err)
	}
