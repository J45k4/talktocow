...
var ChatroomUserTableColumns = struct {
	ID         string
	UserID     string
	ChatroomID string
	CreatedAt  string
}{
	ID:         "chatroom_users.id",
	UserID:     "chatroom_users.user_id",
	ChatroomID: "chatroom_users.chatroom_id",
	CreatedAt:  "chatroom_users.created_at",
}
...
type (
	...
	// This should almost always be used instead of []ChatroomUser.
...
func (q chatroomUserQuery) One(ctx context.Context, exec boil.ContextExecutor) (*ChatroomUser, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: failed to execute a one query for chatroom_users: %w", err)
	}
...
func (q chatroomUserQuery) All(ctx context.Context, exec boil.ContextExecutor) (ChatroomUserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, fmt.Errorf("models: failed to assign all query results to ChatroomUser slice: %w", err)
	}
...
func (q chatroomUserQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: failed to count chatroom_users rows: %w", err)
	}
...
func (q chatroomUserQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, fmt.Errorf("models: failed to check if chatroom_users exists: %w", err)
	}
...
func FindChatroomUser(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*ChatroomUser, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: unable to select from chatroom_users: %w", err)
	}

	if err = chatroomUserObj.doAfterSelectHooks(ctx, exec); err != nil {
		return chatroomUserObj, err
	}
...
func (o *ChatroomUser) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to insert into chatroom_users: %w", err)
	}
...
func (o *ChatroomUser) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update chatroom_users row: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by update for chatroom_users: %w", err)
	}
...
func (q chatroomUserQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all for chatroom_users: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected for chatroom_users: %w", err)
	}
...
func (o ChatroomUserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all in chatroomUser slice: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected all in update all chatroomUser: %w", err)
	}
	return rowsAff, nil
}
...
func (o *ChatroomUser) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert chatroom_users: %w", err)
	}
...
func (o *ChatroomUser) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete from chatroom_users: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by delete for chatroom_users: %w", err)
	}
...
func (q chatroomUserQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from chatroom_users: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by deleteall for chatroom_users: %w", err)
	}
...
func (o ChatroomUserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from chatroomUser slice: %w", err)
	}
...
func (o *ChatroomUserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to reload all in ChatroomUserSlice: %w", err)
	}
...
func ChatroomUserExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, fmt.Errorf("models: unable to check if chatroom_users exists: %w", err)
	}
