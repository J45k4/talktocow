...
func (q diaryEntryQuery) One(ctx context.Context, exec boil.ContextExecutor) (*DiaryEntry, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: failed to execute a one query for diary_entries: %w", err)
	}
...
func (q diaryEntryQuery) All(ctx context.Context, exec boil.ContextExecutor) (DiaryEntrySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, fmt.Errorf("models: failed to assign all query results to DiaryEntry slice: %w", err)
	}
...
func (q diaryEntryQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: failed to count diary_entries rows: %w", err)
	}
...
func (q diaryEntryQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, fmt.Errorf("models: failed to check if diary_entries exists: %w", err)
	}
...
func FindDiaryEntry(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*DiaryEntry, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: unable to select from diary_entries: %w", err)
	}
...
func (o *DiaryEntry) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to insert into diary_entries: %w", err)
	}
...
func (o *DiaryEntry) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update diary_entries row: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by update for diary_entries: %w", err)
	}
...
func (q diaryEntryQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all for diary_entries: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected for diary_entries: %w", err)
	}
...
func (o DiaryEntrySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all in diaryEntry slice: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected all in update all diaryEntry: %w", err)
	}
	return rowsAff, nil
}
...
func (o *DiaryEntry) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert diary_entries: %w", err)
	}
...
func (o *DiaryEntry) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete from diary_entries: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by delete for diary_entries: %w", err)
	}
...
func (q diaryEntryQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from diary_entries: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by deleteall for diary_entries: %w", err)
	}
...
func (o DiaryEntrySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from diaryEntry slice: %w", err)
	}
...
func (o *DiaryEntrySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to reload all in DiaryEntrySlice: %w", err)
	}
...
func DiaryEntryExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, fmt.Errorf("models: unable to check if diary_entries exists: %w", err)
	}
