...
func testUserToManyCourseUsers(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadCourseUsers(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyHomeworkSubmissionComments(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadHomeworkSubmissionComments(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyHomeworkSubmissions(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadHomeworkSubmissions(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyAddOpCourseUsers(t *testing.T) {
	var err error
...
func testUserToManyAddOpHomeworkSubmissionComments(t *testing.T) {
	var err error
...
func testUserToManyAddOpHomeworkSubmissions(t *testing.T) {
	var err error
...
var (
	userDBTypes = map[string]string{`ID`: `integer`, `Name`: `character varying`, `Username`: `character varying`, `PasswordHash`: `character varying`, `CreatedAt`: `timestamp without time zone`, `Bot`: `boolean`}
	_           = bytes.MinRead
)
