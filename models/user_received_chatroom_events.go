...
func (q userReceivedChatroomEventQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UserReceivedChatroomEvent, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: failed to execute a one query for user_received_chatroom_events: %w", err)
	}
...
func (q userReceivedChatroomEventQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserReceivedChatroomEventSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, fmt.Errorf("models: failed to assign all query results to UserReceivedChatroomEvent slice: %w", err)
	}
...
func (q userReceivedChatroomEventQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: failed to count user_received_chatroom_events rows: %w", err)
	}
...
func (q userReceivedChatroomEventQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, fmt.Errorf("models: failed to check if user_received_chatroom_events exists: %w", err)
	}
...
func (userReceivedChatroomEventL) LoadChatroomEvent(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserReceivedChatroomEvent interface{}, mods queries.Applicator) error {
	...
	if err != nil {
		return fmt.Errorf("failed to eager load ChatroomEvent: %w", err)
	}

	var resultSlice []*ChatroomEvent
	if err = queries.Bind(results, &resultSlice); err != nil {
		return fmt.Errorf("failed to bind eager loaded slice ChatroomEvent: %w", err)
	}

	if err = results.Close(); err != nil {
		return fmt.Errorf("failed to close results of eager load for chatroom_events: %w", err)
	}
...
func FindUserReceivedChatroomEvent(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*UserReceivedChatroomEvent, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: unable to select from user_received_chatroom_events: %w", err)
	}
...
func (o *UserReceivedChatroomEvent) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to insert into user_received_chatroom_events: %w", err)
	}
...
func (o *UserReceivedChatroomEvent) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update user_received_chatroom_events row: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by update for user_received_chatroom_events: %w", err)
	}
...
func (q userReceivedChatroomEventQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all for user_received_chatroom_events: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected for user_received_chatroom_events: %w", err)
	}
...
func (o UserReceivedChatroomEventSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all in userReceivedChatroomEvent slice: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected all in update all userReceivedChatroomEvent: %w", err)
	}
	return rowsAff, nil
}
...
func (o *UserReceivedChatroomEvent) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert user_received_chatroom_events: %w", err)
	}
...
func (o *UserReceivedChatroomEvent) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete from user_received_chatroom_events: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by delete for user_received_chatroom_events: %w", err)
	}
...
func (q userReceivedChatroomEventQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from user_received_chatroom_events: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by deleteall for user_received_chatroom_events: %w", err)
	}
...
func (o UserReceivedChatroomEventSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from userReceivedChatroomEvent slice: %w", err)
	}
...
func (o *UserReceivedChatroomEventSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to reload all in UserReceivedChatroomEventSlice: %w", err)
	}
...
func UserReceivedChatroomEventExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, fmt.Errorf("models: unable to check if user_received_chatroom_events exists: %w", err)
	}
