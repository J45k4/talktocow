...
func (q notificationLogQuery) One(ctx context.Context, exec boil.ContextExecutor) (*NotificationLog, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: failed to execute a one query for notification_logs: %w", err)
	}
...
func (q notificationLogQuery) All(ctx context.Context, exec boil.ContextExecutor) (NotificationLogSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, fmt.Errorf("models: failed to assign all query results to NotificationLog slice: %w", err)
	}
...
func (q notificationLogQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: failed to count notification_logs rows: %w", err)
	}
...
func (q notificationLogQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, fmt.Errorf("models: failed to check if notification_logs exists: %w", err)
	}
...
func FindNotificationLog(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*NotificationLog, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: unable to select from notification_logs: %w", err)
	}
...
func (o *NotificationLog) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to insert into notification_logs: %w", err)
	}
...
func (o *NotificationLog) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update notification_logs row: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by update for notification_logs: %w", err)
	}
...
func (q notificationLogQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all for notification_logs: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected for notification_logs: %w", err)
	}
...
func (o NotificationLogSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all in notificationLog slice: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected all in update all notificationLog: %w", err)
	}
	return rowsAff, nil
}
...
func (o *NotificationLog) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to upsert notification_logs: %w", err)
	}
...
func (o *NotificationLog) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete from notification_logs: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by delete for notification_logs: %w", err)
	}
...
func (q notificationLogQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from notification_logs: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by deleteall for notification_logs: %w", err)
	}
...
func (o NotificationLogSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from notificationLog slice: %w", err)
	}
...
func (o *NotificationLogSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to reload all in NotificationLogSlice: %w", err)
	}
...
func NotificationLogExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, fmt.Errorf("models: unable to check if notification_logs exists: %w", err)
	}
