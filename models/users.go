...
func (q userQuery) One(ctx context.Context, exec boil.ContextExecutor) (*User, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: failed to execute a one query for users: %w", err)
	}
...
func (q userQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, fmt.Errorf("models: failed to assign all query results to User slice: %w", err)
	}
...
func (q userQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: failed to count users rows: %w", err)
	}
...
func (q userQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, fmt.Errorf("models: failed to check if users exists: %w", err)
	}
...
func (userL) LoadChatroomUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	if err != nil {
		return fmt.Errorf("failed to eager load chatroom_users: %w", err)
	}

	var resultSlice []*ChatroomUser
	if err = queries.Bind(results, &resultSlice); err != nil {
		return fmt.Errorf("failed to bind eager loaded slice chatroom_users: %w", err)
	}

	if err = results.Close(); err != nil {
		return fmt.Errorf("failed to close results in eager load on chatroom_users: %w", err)
	}
	if err = results.Err(); err != nil {
		return fmt.Errorf("error occurred during iteration of eager loaded relations for chatroom_users: %w", err)
	}
...
func (userL) LoadCourseUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return fmt.Errorf("failed to eager load course_users: %w", err)
	}

	var resultSlice []*CourseUser
	if err = queries.Bind(results, &resultSlice); err != nil {
		return fmt.Errorf("failed to bind eager loaded slice course_users: %w", err)
	}

	if err = results.Close(); err != nil {
		return fmt.Errorf("failed to close results in eager load on course_users: %w", err)
	}
	if err = results.Err(); err != nil {
		return fmt.Errorf("error occurred during iteration of eager loaded relations for course_users: %w", err)
	}
...
func (userL) LoadWhoPostedUserDiaryEntries(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return fmt.Errorf("failed to eager load diary_entries: %w", err)
	}

	var resultSlice []*DiaryEntry
	if err = queries.Bind(results, &resultSlice); err != nil {
		return fmt.Errorf("failed to bind eager loaded slice diary_entries: %w", err)
	}

	if err = results.Close(); err != nil {
		return fmt.Errorf("failed to close results in eager load on diary_entries: %w", err)
	}
	if err = results.Err(); err != nil {
...
func (userL) LoadDiaryEntryComments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return fmt.Errorf("failed to eager load diary_entry_comments: %w", err)
	}

	var resultSlice []*DiaryEntryComment
	if err = queries.Bind(results, &resultSlice); err != nil {
		return fmt.Errorf("failed to bind eager loaded slice diary_entry_comments: %w", err)
	}

	if err = results.Close(); err != nil {
		return fmt.Errorf("failed to close results in eager load on diary_entry_comments: %w", err)
	}
	if err = results.Err(); err != nil {
		return fmt.Errorf("error occurred during iteration of eager loaded relations for diary_entry_comments: %w", err)
	}
...
func (userL) LoadHomeworkSubmissionComments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return fmt.Errorf("failed to eager load homework_submission_comments: %w", err)
	}

	var resultSlice []*HomeworkSubmissionComment
	if err = queries.Bind(results, &resultSlice); err != nil {
		return fmt.Errorf("failed to bind eager loaded slice homework_submission_comments: %w", err)
	}

	if err = results.Close(); err != nil {
		return fmt.Errorf("failed to close results in eager load on homework_submission_comments: %w", err)
	}
	if err = results.Err(); err != nil {
		return fmt.Errorf("error occurred during iteration of eager loaded relations for homework_submission_comments: %w", err)
	}
...
func (userL) LoadHomeworkSubmissions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return fmt.Errorf("failed to eager load homework_submissions: %w", err)
	}

	var resultSlice []*HomeworkSubmission
	if err = queries.Bind(results, &resultSlice); err != nil {
		return fmt.Errorf("failed to bind eager loaded slice homework_submissions: %w", err)
	}

	if err = results.Close(); err != nil {
		return fmt.Errorf("failed to close results in eager load on homework_submissions: %w", err)
	}
	if err = results.Err(); err != nil {
...
func (userL) LoadLoginSessions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return fmt.Errorf("failed to eager load login_sessions: %w", err)
	}

	var resultSlice []*LoginSession
	if err = queries.Bind(results, &resultSlice); err != nil {
		return fmt.Errorf("failed to bind eager loaded slice login_sessions: %w", err)
	}

	if err = results.Close(); err != nil {
		return fmt.Errorf("failed to close results in eager load on login_sessions: %w", err)
	}
	if err = results.Err(); err != nil {
		return fmt.Errorf("error occurred during iteration of eager loaded relations for login_sessions: %w", err)
	}
...
func (userL) LoadMessages(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return fmt.Errorf("failed to eager load messages: %w", err)
	}

	var resultSlice []*Message
	if err = queries.Bind(results, &resultSlice); err != nil {
		return fmt.Errorf("failed to bind eager loaded slice messages: %w", err)
	}

	if err = results.Close(); err != nil {
		return fmt.Errorf("failed to close results in eager load on messages: %w", err)
	}
	if err = results.Err(); err != nil {
...
func (userL) LoadSharedDiaryEntries(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return fmt.Errorf("failed to eager load shared_diary_entries: %w", err)
	}

	var resultSlice []*SharedDiaryEntry
	if err = queries.Bind(results, &resultSlice); err != nil {
		return fmt.Errorf("failed to bind eager loaded slice shared_diary_entries: %w", err)
	}

	if err = results.Close(); err != nil {
		return fmt.Errorf("failed to close results in eager load on shared_diary_entries: %w", err)
	}
	if err = results.Err(); err != nil {
		return fmt.Errorf("error occurred during iteration of eager loaded relations for shared_diary_entries: %w", err)
	}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*User, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf("models: unable to select from users: %w", err)
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to insert into users: %w", err)
	}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update users row: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by update for users: %w", err)
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all for users: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected for users: %w", err)
	}
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, fmt.Errorf("models: unable to update all in user slice: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: unable to retrieve rows affected all in update all user: %w", err)
	}
	return rowsAff, nil
}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete from users: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by delete for users: %w", err)
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from users: %w", err)
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, fmt.Errorf("models: failed to get rows affected by deleteall for users: %w", err)
	}
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, fmt.Errorf("models: unable to delete all from user slice: %w", err)
	}
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return fmt.Errorf("models: unable to reload all in UserSlice: %w", err)
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, fmt.Errorf("models: unable to check if users exists: %w", err)
	}
